...
class Team(Base):
    ...
    tricode = Column(String(3), unique=True, index=True, nullable=False)  # e.g., "SEA"
    name = Column(String(100), nullable=False)  # e.g., "Seattle Storm"
    city = Column(String(50), nullable=False)  # e.g., "Seattle"
